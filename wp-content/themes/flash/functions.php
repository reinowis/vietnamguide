...
function flash_widgets_init() {
    ...
    // Footer 6
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Sidebar 6', 'flash' ),
        'id'            => 'flash_footer_sidebar6',
        'description'   => esc_html__( 'Add widgets here for footer sidebar 6.', 'flash' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '<h3 class="widget-title">',
        'after_title'   => '</h3>',
    ...
    // Footer 7
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Sidebar 7', 'flash' ),
        'id'            => 'flash_footer_sidebar7',
        'description'   => esc_html__( 'Add widgets here for footer sidebar 7.', 'flash' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '<h3 class="widget-title">',
        'after_title'   => '</h3>',
...
function flash_scripts() {
    ...
    // Carousel
    wp_enqueue_style( 'carousel', get_template_directory_uri() . '/css/owl.carousel.css' , array(), false, false);
    wp_enqueue_style( 'carousel-theme', get_template_directory_uri() . '/css/owl.theme.default.css' , array(), false, false);
